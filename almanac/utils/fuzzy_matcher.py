...
class FuzzyMatcher:
    ...
    def __init__(
        ...
        _sorted_passing_fuzzes = tuple(sorted(_passing_fuzzes, key=attrgetter("ratio")))
    ...
    @staticmethod
    def fuzz(reference: str, comparison: str) -> FuzzResult:
    ...
    @property
    def results(self) -> Tuple[FuzzResult, ...]:
